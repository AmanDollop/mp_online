              ...
              child: Column(
                ...
                children: [
                  CommonWidgets.imageView(
                      image:controller.getProviderData.shopBanner??'',
                  ...
                  ListTile(
                    ...
                    title: Text('${controller.getProviderData.firstName} ${controller.getProviderData.lastName}',style: MyTextStyle.titleStyle16bb,),
                    subtitle: Text('${controller.getProviderData.shopAddress}',style: MyTextStyle.titleStyle12b,),
                    trailing: GestureDetector(
                      onTap:(){
                        controller.clickOnChatIcon();
                      },
                      child: Container(
                        height: 35.px,
                        width: 35.px,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(controller.getProviderData.mobile??'',style: MyTextStyle.titleStyle16bb,),
              )
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 5.px),
                child: Text(controller.getProviderData.email??'',style: MyTextStyle.titleStyle16bb,),
              )
            ],
          ),
          SizedBox(height: 15.px,),
          Row(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 5.px),
                child: Text(controller.getProviderData.createdAt??'',style: MyTextStyle.titleStyle16bb,),
              )
            ],
          ),
          SizedBox(height: 15.px,),
          Row(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 5.px),
                child: Text(controller.getProviderData.address??'',style: MyTextStyle.titleStyle16bb,),
              )
            ],
          ),
        ],
