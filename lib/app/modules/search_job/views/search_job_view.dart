...
class SearchJobView extends GetView<SearchJobController> {
        ...
        body:Obx(() {
          ...
          return  Column(
            children: [
              Container(
                height: 100.px,
                padding: EdgeInsets.only(top: 15,left: 10.px,right: 10.px,bottom: 5.px),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        margin: EdgeInsets.only(right: 5.px,top: 5.px),
                    ...
                    Flexible(
                        child: CommonWidgets.commonTextFieldForLoginSignUP(
                          controller: controller.searchController,
                            hintText: StringConstants.searchJobsSkillPeople,
                            onChanged: (value){
  ...
  Widget showAllJobVacancy(){
    ...
    GetBuilder<SearchJobController>(builder: (context){
      return ListView.builder(
          ...
          itemBuilder: (context, index){
            JobVacancyResult item=controller.filterJobList[index];
            return
              Card(
