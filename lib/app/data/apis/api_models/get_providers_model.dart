class GetProviderModel {
  String? message;
  List<GetProviderData>? data;
  String? status;

  GetProviderModel({this.message, this.data, this.status});

  GetProviderModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      data = <GetProviderData>[];
      json['data'].forEach((v) {
        data!.add(GetProviderData.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class GetProviderData {
  ...
  GetProviderData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
